...
import { ArrowLeft, CheckCircle2, FileText, User, BookOpen, Camera, Briefcase, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-white max-w-[430px] mx-auto font-sans text-gray-900 pb-24">
      ...
      <div className="relative w-full h-[280px] overflow-hidden">
        ...
        <div className="absolute bottom-6 left-5 right-5">
          <h1 className="text-[32px] font-black text-white leading-tight tracking-tight">Application Requirements</h1>
          <p className="text-[14px] text-white/85 mt-2 font-medium">Everything you need to apply for your dream job through Pathway Agency.</p>
        </div>
      </div>
      ...
      >
        <h2 className="text-[22px] font-black text-gray-900 mb-2">Who Can Apply?</h2>
        ...
        <div className="rounded-3xl overflow-hidden mb-5 shadow-sm border border-blue-100">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-4">
            <h3 className="text-[18px] font-black text-white">1. Fresh Graduates</h3>
            <p className="text-[13px] text-blue-100 mt-1">0 Years Experience Opportunities</p>
          </div>
          <div className="bg-blue-50 px-5 py-5">
            <p className="text-[14px] text-gray-700 leading-relaxed">
              If you graduated between 2015 – 2018 E.C. and are not currently employed, you are eligible to apply for our 0-year experience job opportunities. We have carefully curated verified entry-level positions at embassies, NGOs, and international companies specifically for fresh talent like you.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-3xl overflow-hidden shadow-sm border border-emerald-100">
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-4">
            <h3 className="text-[18px] font-black text-white">2. Experienced Professionals</h3>
            <p className="text-[13px] text-emerald-100 mt-1">Currently Employed or Graduated Before 2015 E.C.</p>
          </div>
          <div className="bg-emerald-50 px-5 py-5">
            <p className="text-[14px] text-gray-700 leading-relaxed">
              If you are currently employed or graduated before 2015 E.C., no problem at all — you are fully welcome to apply. We have a wide range of mid-level and senior positions that match your professional background and expertise across all our partner organizations.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <h2 className="text-[22px] font-black text-gray-900 mb-6">Required Documents</h2>

        {/* Fresh Grad Docs */}
        <h3 className="text-[16px] font-black text-blue-700 mb-4">For Fresh Graduates (0 Year Experience)</h3>
        <div className="grid gap-3 mb-8">
          {FRESH_GRAD_DOCS.map((doc, i) => (
        ...
        {/* Experienced Docs */}
        <h3 className="text-[16px] font-black text-emerald-700 mb-4">For Experienced Professionals</h3>
        <div className="grid gap-3">
          {EXPERIENCED_DOCS.map((doc, i) => (
      ...
      >
        <h3 className="text-[17px] font-black text-amber-800 mb-3">Important Note</h3>
        <p className="text-[14px] text-amber-900 leading-relaxed">
          All documents must be submitted in clear, legible digital format (PDF or JPEG). Pathway Agency verifies every application before forwarding to partner employers. Incomplete applications will not be processed. Ensure all documents are current and valid before submitting.
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="px-5 pb-8"
      >
        <h2 className="text-[22px] font-black text-gray-900 mb-5">Our Candidates at Work</h2>
