...
import { getInterviewByEmail, submitInterviewAnswers, InterviewSession } from "@/lib/db";
...
const DEFAULT_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      "Complain to all your colleagues to build opposition",
      "Raise your concern respectfully through the proper channels",
      "Immediately resign without discussion"
    ],
    correctIndex: 2
  }
];
