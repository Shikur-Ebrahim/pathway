  ...
  return (
    <section className="relative w-full min-h-[90vh] flex flex-col justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-24 pb-16 lg:pt-32 lg:pb-24">
      ...
      <motion.div 
        ...
        className="absolute top-10 left-[-10%] w-72 h-72 lg:w-96 lg:h-96 bg-blue-400/20 rounded-full blur-3xl pointer-events-none"
      />
      <motion.div 
        animate={{ y: [0, 40, 0], opacity: [0.3, 0.6, 0.3] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-10 right-[-10%] w-80 h-80 lg:w-[30rem] lg:h-[30rem] bg-purple-400/20 rounded-full blur-3xl pointer-events-none"
      />
          ...
          <div className="flex-1 w-full text-center lg:text-left">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100/50 border border-blue-200 text-blue-700 text-sm font-semibold mb-6">
                ...
                <span>2019 Ethiopian New Year Special</span>
              </div>
            ...
            >
              <button 
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-[16px] md:text-lg shadow-xl shadow-blue-500/25 flex items-center justify-center gap-2 hover:shadow-2xl hover:shadow-blue-500/40 hover:-translate-y-1 transition-all"
              >
                Create Free Account
              ...
              <button 
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white border-2 border-gray-100 text-gray-800 font-bold text-[16px] md:text-lg shadow-sm hover:border-gray-200 hover:bg-gray-50 flex items-center justify-center gap-2 hover:-translate-y-1 transition-all"
              >
          ...
          <div className="flex-1 w-full max-w-lg mx-auto lg:max-w-none">
            ...
            >
              ...
              {[
                ...
                <div 
                  key={idx} 
                  className="bg-white/80 backdrop-blur-xl border border-white/60 p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all group"
                >
