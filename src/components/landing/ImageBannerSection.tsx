...
export const ImageBannerSection = ({ lang }: { lang: Language }) => {
  ...
  const images = [
    { url: "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=800&q=80", title: lang === "am" ? "የቢሮ አካባቢ" : "Office Environment", slug: "office-environment" },
    { url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=800&q=80", title: lang === "am" ? "የሙያ ቡድን ሥራ" : "Professional Teamwork", slug: "teamwork" },
    { url: "https://images.unsplash.com/photo-1573164574572-cb89e39749b4?auto=format&fit=crop&w=800&q=80", title: lang === "am" ? "የሙያ ዕድገት" : "Career Growth", slug: "career-growth" },
    { url: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=800&q=80", title: lang === "am" ? "የሥራ ቃለ-መጠይቆች" : "Job Interviews", slug: "interviews" },
  ];
